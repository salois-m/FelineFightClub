  package
{
	...
	{	
		...
		[Embed(source = "../assets/Dojo.png")]
		private var Dojo:Class;
		...
		private var npcReaction:Number = 0.4;
		...
		{			
			// create flixel sprite for dojo
			var dojo:FlxSprite = new FlxSprite(0, 0, Dojo);
			// display dojo in game
			add(dojo);
			
			//prepare the FlxSaves
			actionSaver = new FlxSave();
			actionSaver.bind("Stage3Attacked");
			
			timeSaver = new FlxSave()
			timeSaver.bind("Stage3Time");
